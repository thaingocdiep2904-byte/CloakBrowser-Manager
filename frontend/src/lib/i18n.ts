...
export const translations = {
  vi: {
    ...
    table: {
      ...
      bulk_startup: "Đặt Startup URL",
      bulk_bookmark: "Đặt Bookmark",
      bulk_group: "Đặt Nhóm",
      bulk_cache: "Xóa Cache",
      bulk_extension: "Cài Extension",
      bulk_export: "Xuất Excel",
      ...
      no_profiles: "Không tìm thấy profile nào. Click 'Tạo mới' hoặc 'Nhập Excel' để bắt đầu.",
  ...
  en: {
    ...
    table: {
      ...
      bulk_bookmark: "Set Bookmark",
      bulk_group: "Set Group",
      bulk_cache: "Clear Cache",
      bulk_extension: "Assign Extension",
      ...
      no_profiles: "No profiles found. Click 'Create' or 'Import CSV' to start.",
